...
class StructuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create structure" do
    assert_difference("Structure.count") do
      post structures_url, params: { structure: { description: @structure.description, img_url: @structure.img_url, name: @structure.name } }
    end
  ...
  test "should update structure" do
    patch structure_url(@structure), params: { structure: { description: @structure.description, img_url: @structure.img_url, name: @structure.name } }
