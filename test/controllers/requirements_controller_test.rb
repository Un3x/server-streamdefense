...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference("Requirement.count") do
      post requirements_url, params: { requirement: { required_level: @requirement.required_level, structures_id: @requirement.structures_id } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { required_level: @requirement.required_level, structures_id: @requirement.structures_id } }
